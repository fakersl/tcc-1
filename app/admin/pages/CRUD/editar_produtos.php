        ...
        <div class="p-6">
            ...
            <form method="POST">
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    ...
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700" for="nomeProduto">Nome:</label>
                        <input class="block w-full p-2 mt-1 border border-gray-300 rounded-md" type="text"
                            name="nomeProduto" value="<?php echo $produto['nomeProduto']; ?>" required>
                    </div>

                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700" for="precoProduto">Preço:</label>
                        <input class="block w-full p-2 mt-1 border border-gray-300 rounded-md" type="number"
                            name="precoProduto" value="<?php echo $produto['precoProduto']; ?>" required>
                    </div>
                    ...
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700" for="marcaProduto">Marca:</label>
                        <input class="block w-full p-2 mt-1 border border-gray-300 rounded-md" type="text"
                            name="marcaProduto" value="<?php echo $produto['marcaProduto']; ?>" required>
                    </div>

                    <div class="sm:col-span-2">
                        <label class="block text-sm font-medium text-gray-700" for="marcaProduto">Descrição:</label>
                        <input class="block w-full p-2 mt-1 border border-gray-300 rounded-md" type="text"
                            name="descricaoProduto" value="<?php echo $produto['descricaoProduto']; ?>" required>
                    </div>
                    ...
                    <a  class="text-white inline-flex items-center bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800" href="listar_produtos.php">Voltar</a>
            </form>
        </div>
    </div>
    </div>
